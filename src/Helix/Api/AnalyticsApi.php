...
class AnalyticsApi extends AbstractApi
{
     ...
     *
     *                                             The start date must be within one year of today’s date. If you specify an earlier
     *                                             date, the API ignores it and uses a date that’s one year prior to today’s date. If you
     *                                             don’t specify a start and end date, the report includes all available data for the
     ...
     *
     *                                             Specify an end date only if you provide a start date. Because it can take up to two days
     *                                             for the data to be available, you must specify an end date that’s earlier than today
     *                                             minus one to two days. If not, the API ignores your end date and uses an end date that
     *                                             is today minus one to two days.
     * @param int                  $first          The maximum number of report URLs to return per page in the response. The minimum page
     *                                             size is 1 URL per page and the maximum is 100 URLs per page. The default is 20.
     *
     *                                             NOTE: While you may specify a maximum value of 100, the response will contain at most 20
     *                                             URLs per page.
     * @param string|null          $after          The cursor used to get the next page of results. The Pagination object in the response
     *                                             contains the cursor’s value.
     *
